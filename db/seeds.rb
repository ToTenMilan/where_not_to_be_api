...
u = User.create(name: 'John Tourist', lat: 50.049660, lng: 19.944750)
...
100.times do
  User.create(name: FFaker::Name.name, lat: rand(50.050000..50.050100), lng: rand(19.947030..19.947100))
end
